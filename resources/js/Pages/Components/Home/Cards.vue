  ...
  <v-card outlined class="">
    <v-card-text class="">
      <v-row justify="space-between " class="px-2 py-2">
        <div class="text-xl" v-text="title"></div>
        <Link v-if="more" :href="more.link" class="">
          <span> View More </span>
          ...
          >
            <v-hover v-slot="{ hover }">
              <v-sheet rounded="sm" class="ma-1" :elevation="hover ? '3' : '0'">
                <div class="grid">
                  <v-img class="rounded-sm" contain :src="'images/estate.jpg'">
                    <div
                      class="
                        absolute
                        rounded-md
                      ...
                      v-text="
                        (
                          ((product.offprice - product.pricenow) /
                            product.offprice) *
                          100
                        ).toFixed(0) + '% OFF'
                      "
                  ...
                  <div class="grid px-2 pt-2 pb-6">
                    ...
                    <div
                      ...
                      v-text="currency + ' ' + product.pricenow"
                    ></div>
                    <div
                      class="line-through text-xs"
                      v-text="currency + ' ' + product.offprice"
                    ></div>
                    <div>
                      <v-rating
