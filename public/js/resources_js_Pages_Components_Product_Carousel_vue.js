...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    return {
      innitialPrice: 36363,
      price: 38383,
      images: ["images/slide-1.jpg", "images/slide-2.jpg", "images/slide-3.png"]
    };
  }
});
...
var render = function () {
  ...
  return _c(
    ...
    _vm._l(_vm.images, function (image, index) {
      return _c("v-carousel-item", { key: image, attrs: { src: image } }, [
            ...
            [
              _vm._v(
                "\n        " +
                  _vm._s(
                    (
                      ((_vm.innitialPrice - _vm.price) / _vm.innitialPrice) *
                      100
                    ).toFixed(0) + "%"
                  ) +
                  "\n      "
